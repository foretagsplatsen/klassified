(function (root, factory) {if (typeof define === 'function' && define.amd) { define(factory); } else { root.objectjs = factory(root.$); } }(this, function ($) {/**
...
require(["objectjs"]);
define('jquery', function () {   return $;});return require('objectjs');}));
